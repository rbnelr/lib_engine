...
#if 1 // Modified
typedef void (* GLFWcursorposrelativefun)(GLFWwindow*,double,double);
#endif
...
#if 1 // Modified
GLFWAPI GLFWcursorposrelativefun glfwSetCursorPosRelativeCallback(GLFWwindow* window, GLFWcursorposrelativefun cbfun);
#endif
